...
namespace tbkkData.Controllers.ProductLossReduction
{
    ...
    [ApiController]
    public class Product_Loss_ReductionController : ControllerBase
    {
        ...
        public Product_Loss_ReductionController(tbkkDataContext context)
        {
            _context = context;
        }

        // GET: api/Product_Loss_Reduction
        [HttpGet]
        public List<object> GetProduct_Loss_Reduction()
        {
            List<object> list = new List<object>();
            list.Add(
                _context.Product_Loss_Reduction.Where(s => s.type_productLoossID == 1)
                .GroupBy(g => new {
                    Year = g.Date.Year,
                    Month = g.Date.Month,
                })
        ...
        // GET: api/Product_Loss_Reduction/5
        [HttpGet("{id}")]
        ...
        // PUT: api/Product_Loss_Reduction/5
        [HttpPut("{id}")]
        ...
        // POST: api/Product_Loss_Reduction
        [HttpPost]
        ...
        // DELETE: api/Product_Loss_Reduction/5
        [HttpDelete("{id}")]
