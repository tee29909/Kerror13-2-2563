...
namespace tbkkData.Controllers.ProductLossReduction_A25_A17_
{
    ...
    [ApiController]
    public class Product_Loss_ReductionA17Controller : ControllerBase
    {
        private readonly tbkkDataContext _context;

        public Product_Loss_ReductionA17Controller(tbkkDataContext context)
        {
            _context = context;
        }

        // GET: api/Product_Loss_ReductionA17
        [HttpGet]
        public List<object> GetProduct_Loss_Reduction()
        {
            List<object> list = new List<object>();
            list.Add(
                 _context.Product_Loss_Reduction.Where(s => s.type_productLoossID == 4)
                 .GroupBy(g => new {
                     Year = g.Date.Year,
                     Month = g.Date.Month,
                 })
        ...
        // GET: api/Product_Loss_ReductionA17/5
        [HttpGet("{id}")]
        ...
        // PUT: api/Product_Loss_ReductionA17/5
        [HttpPut("{id}")]
        ...
        // POST: api/Product_Loss_ReductionA17
        [HttpPost]
        ...
        // DELETE: api/Product_Loss_ReductionA17/5
        [HttpDelete("{id}")]
