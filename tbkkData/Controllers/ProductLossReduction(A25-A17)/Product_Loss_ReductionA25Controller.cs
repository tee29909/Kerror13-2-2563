...
namespace tbkkData.Controllers.ProductLossReduction_A25_A17
{
    ...
    [ApiController]
    public class Product_Loss_ReductionA25Controller : ControllerBase
    {
        ...
        // GET: api/Product_Loss_ReductionA25
        [HttpGet]
        public List<object> GetProduct_Loss_Reduction()
        {
            List<object> list = new List<object>();
            list.Add(
                 _context.Product_Loss_Reduction.Where(s => s.type_productLoossID == 3)
                 .GroupBy(g => new {
                     Year = g.Date.Year,
                     Month = g.Date.Month,
                 })
        ...
        // GET: api/Product_Loss_ReductionA25/5
        [HttpGet("{id}")]
        ...
        // PUT: api/Product_Loss_ReductionA25/5
        [HttpPut("{id}")]
        ...
        // POST: api/Product_Loss_ReductionA25
        [HttpPost]
        ...
        // DELETE: api/Product_Loss_ReductionA25/5
        [HttpDelete("{id}")]
